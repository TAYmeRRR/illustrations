...
const illustrationsData = {
  ...
  page5: [
    { img: "cs.jpg.jpg", alt: "Иллюстрация 1-10", author: "", description: "Рассказ Игоря Бондаренко «Только им снился зеленый луг» рассказывает о героях, которые живут в тяжелое время и испытывают много боли и лишений. Но несмотря на трудности, они видят во сне зеленый луг — место спокойствия, свободы и радости, которого нет в их реальной жизни. Зеленый луг символизирует их мечты о мире и счастье, к которым они стремятся в душе. Этот сон — единственное светлое и доброе, что у них есть, что помогает им не потерять надежду. Главная идея рассказа — показать, что даже в самых тяжелых обстоятельствах человек сохраняет способность мечтать и верить в лучшее, и именно эти мечты делают жизнь значимой." },
